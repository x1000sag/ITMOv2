...
| P1-02-03 | Формулировка User stories and use cases | gpt-5 | CRTF + Few-Shots | [Промт](./ai_work_record/p1-02-03_prompt.md) | [Патч](./ai_work_record/p1-02-03_answer.md) | Всё, кроме заполненого раздела использования AI | Удалена информация о AS IS и исправлены ошибки парсинга `mermaid` | Проверка на галюценации и включение информации о AS IS |
| P1-03 |  |  |  |  |  |  |  |  |
